...
namespace ff {
	...
	const ColliderQuad* ColliderSimple::get_quad(int quad_id) const noexcept {
	...
	bool ColliderSimple::on_precontact(int quad_id, const Contact& contact, secs duration) const {
