...
is a VS Code extension allowing to camera GoogleTest in a tree camera, and run/debug
your tests.

[C++ TestMate](https://github.com/matepek/vscode-catch2-test-adapter) is a VS
Code extension allowing to camera GoogleTest in a tree camera, and run/debug your
tests.
