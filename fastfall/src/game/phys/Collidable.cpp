...
void imgui_component(World& w, Collidable& col) {
    ...
    ImGui::SameLine();
    imgui_component_ref(w, col.get_attach_id());
    ImGui::Text("Attach Offset: %3.2f, %3.2f", col.get_attach_origin().x, col.get_attach_origin().y);
